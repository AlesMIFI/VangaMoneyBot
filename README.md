...
🤖 Используемые модели
Random Forest (ML) - Случайный лес

ARIMA (Статистика) - Авторегрессионная модель

Prophet (Meta) - Прогнозирование временных рядов

LSTM (PyTorch) - Рекуррентная нейросеть

GRU (PyTorch) - Упрощенная версия LSTM
...
Обучение 5 моделей параллельно:
